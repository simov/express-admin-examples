...
DROP SCHEMA IF EXISTS `express-admin-stress` ;
CREATE SCHEMA IF NOT EXISTS `express-admin-stress` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `express-admin-stress` ;
...
CREATE  TABLE IF NOT EXISTS `item` (
  ...
  PRIMARY KEY (`id`) ,
  INDEX `fk_item_item_choice1_idx` (`item_choice1_id` ASC) ,
  INDEX `fk_item_item_choice21_idx` (`item_choice2_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `item_has_item_group1` (
  ...
  INDEX `fk_item_has_item_group1_item_group11_idx` (`item_group1_id` ASC) ,
  INDEX `fk_item_has_item_group1_item1_idx` (`item_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `item_has_item_group2` (
  ...
  INDEX `fk_item_has_item_group2_item_group21_idx` (`item_group2_id` ASC) ,
  INDEX `fk_item_has_item_group2_item1_idx` (`item_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `inline_one1` (
  ...
  INDEX `fk_inline_one1_inline_one1_choice11_idx` (`inline_one1_choice1_id` ASC) ,
  INDEX `fk_inline_one1_inline_one1_choice21_idx` (`inline_one1_choice2_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `inline_one2` (
  ...
  PRIMARY KEY (`id`) ,
  INDEX `fk_inline_one2_item1_idx` (`item_id` ASC) ,
  INDEX `fk_inline_one2_inline_one2_choice11_idx` (`inline_one2_choice1_id` ASC) ,
  INDEX `fk_inline_one2_inline_one2_choice21_idx` (`inline_one2_choice2_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `inline_many1` (
  ...
  PRIMARY KEY (`id`) ,
  INDEX `fk_inline_many1_item1_idx` (`item_id` ASC) ,
  INDEX `fk_inline_many1_inline_many1_choice11_idx` (`inline_many1_choice1_id` ASC) ,
  INDEX `fk_inline_many1_inline_many1_choice21_idx` (`inline_many1_choice2_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `inline_many2` (
  ...
  PRIMARY KEY (`id`) ,
  INDEX `fk_inline_many2_item1_idx` (`item_id` ASC) ,
  INDEX `fk_inline_many2_inline_many2_choice11_idx` (`inline_many2_choice1_id` ASC) ,
  INDEX `fk_inline_many2_inline_many2_choice21_idx` (`inline_many2_choice2_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `inline_one1_has_inline_one1_group1` (
  ...
  INDEX `fk_inline_one1_has_inline_one1_group1_inline_one1_group11_idx` (`inline_one1_group1_id` ASC) ,
  INDEX `fk_inline_one1_has_inline_one1_group1_inline_one11_idx` (`inline_one1_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `inline_one1_has_inline_one1_group2` (
  ...
  INDEX `fk_inline_one1_has_inline_one1_group2_inline_one1_group21_idx` (`inline_one1_group2_id` ASC) ,
  INDEX `fk_inline_one1_has_inline_one1_group2_inline_one11_idx` (`inline_one1_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `inline_one2_has_inline_one2_group1` (
  ...
  INDEX `fk_inline_one2_has_inline_one2_group1_inline_one2_group11_idx` (`inline_one2_group1_id` ASC) ,
  INDEX `fk_inline_one2_has_inline_one2_group1_inline_one21_idx` (`inline_one2_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `inline_one2_has_inline_one2_group2` (
  ...
  INDEX `fk_inline_one2_has_inline_one2_group2_inline_one2_group21_idx` (`inline_one2_group2_id` ASC) ,
  INDEX `fk_inline_one2_has_inline_one2_group2_inline_one21_idx` (`inline_one2_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `inline_many1_has_inline_many1_group1` (
  ...
  INDEX `fk_inline_many1_has_inline_many1_group1_inline_many1_group1_idx` (`inline_many1_group1_id` ASC) ,
  INDEX `fk_inline_many1_has_inline_many1_group1_inline_many11_idx` (`inline_many1_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `inline_many1_has_inline_many1_group2` (
  ...
  INDEX `fk_inline_many1_has_inline_many1_group2_inline_many1_group2_idx` (`inline_many1_group2_id` ASC) ,
  INDEX `fk_inline_many1_has_inline_many1_group2_inline_many11_idx` (`inline_many1_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `inline_many2_has_inline_many2_group1` (
  ...
  INDEX `fk_inline_many2_has_inline_many2_group1_inline_many2_group1_idx` (`inline_many2_group1_id` ASC) ,
  INDEX `fk_inline_many2_has_inline_many2_group1_inline_many21_idx` (`inline_many2_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `inline_many2_has_inline_many2_group2` (
  ...
  INDEX `fk_inline_many2_has_inline_many2_group2_inline_many2_group2_idx` (`inline_many2_group2_id` ASC) ,
  INDEX `fk_inline_many2_has_inline_many2_group2_inline_many21_idx` (`inline_many2_id` ASC) ,
